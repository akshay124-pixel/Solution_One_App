...
const IncompleteOrdersTable = ({ orders, onView, onEdit, onDelete, loading, page, setPage, totalPages, totalRecords }) => {
      ...
      >
        <div style={{
          ...
          <p style={{ color: "#64748b", fontSize: "1rem", fontWeight: "500", margin: 0 }}>
            No incomplete orders found in the system
          </p>
          <p style={{ color: "#9ca3af", fontSize: "0.875rem", margin: "12px 0 0 0" }}>
            Create an incomplete order to get started
          </p>
        </div>
      </td>
    </tr>
  ...
  return (
    ...
    >
      ...
      <div
        className="incomplete-orders-table-container"
        style={{
          overflowX: "auto",
          overflowY: "auto",
          height: "600px",
      ...
      >
        <Table hover style={{ margin: 0, width: "100%", minWidth: "1800px" }}>
          <thead
          ...
          <tbody>
            {(!orders || orders.length === 0) && !loading ? renderEmptyState() : orders.map((order, index) => (
              <tr
                key={order._id || index}
                style={{
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.backgroundColor = order.status === "Closed" ? "#dcfce7" : "#f0f9ff";
                }}
                onMouseLeave={(e) => {
                  const style = getRowStyle(order);
              ...
              >
                ...
                <td
                  ...
                  title={order.pendingParts?.map(p => p.partName).join(", ")}
                >
                  {order.pendingParts?.map(p => p.partName).join(", ") || "-"}
                </td>
                <td style={{
                  padding: "10px 15px",
                  height: "50px",
                  ...
                  <div style={{
                    ...
                    {isGlobalAdmin && onDelete && (
                      ...
                      >
                        ...
                        >
                          <mask id="incomplete-path-1-inside-1_8_19" fill="white">
                            <path d="M0 0H33V35C33 37.2091 31.2091 39 29 39H4C1.79086 39 0 37.2091 0 35V0Z" />
                          </mask>
                          <path
                            d="M0 0H33H0ZM37 35C37 39.4183 33.4183 43 29 43H4C-0.418278 43 -4 39.4183 -4 35H4H29H37ZM4 43C-0.418278 43 -4 39.4183 -4 35V0H4V35V43ZM37 0V35C37 39.4183 33.4183 43 29 43V35V0H37Z"
                            fill="white"
                            mask="url(#incomplete-path-1-inside-1_8_19)"
                          />
      ...
      <style>
        {`
          ...
          .incomplete-orders-table-container::-webkit-scrollbar {
            width: 10px;
            height: 10px;
          }
          .incomplete-orders-table-container::-webkit-scrollbar-track {
            background: #e6f0fa;
            border-radius: 4px;
          }
          .incomplete-orders-table-container::-webkit-scrollbar-thumb {
            background: #2575fc;
            border-radius: 4px;
            min-height: 40px;
            min-width: 40px;
          }
          .incomplete-orders-table-container::-webkit-scrollbar-thumb:hover {
            background: #1d5bb8;
          }
...
export default IncompleteOrdersTable;
