...
const DeleteIncompleteOrderModal = ({ isOpen, onClose, onDelete, order }) => {
        ...
        >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              ...
              <div>
                ...
                <p style={{ 
                  ...
                  This will permanently delete the incomplete order and all associated data.
                </p>
              </div>
            </div>
          </Alert>
          ...
          <div style={{ 
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px" }}>
              <div>
                <strong style={{ color: "#6b7280", fontSize: "0.75rem" }}>Order Number:</strong>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px", marginTop: "8px" }}>
              <div>
                <strong style={{ color: "#6b7280", fontSize: "0.75rem" }}>Product Category:</strong>
                <div style={{ color: "#1f2937", fontWeight: "500", fontSize: "0.875rem" }}>
                  {order.productCategory || "-"}
                </div>
              </div>
              <div>
                <strong style={{ color: "#6b7280", fontSize: "0.75rem" }}>Status:</strong>
                <div style={{ color: "#1f2937", fontWeight: "500", fontSize: "0.875rem" }}>
                  {order.status || "-"}
                </div>
              </div>
            ...
            {order.remarks && (
              <div style={{ marginTop: "8px" }}>
                <strong style={{ color: "#6b7280", fontSize: "0.75rem" }}>Remarks:</strong>
                <div style={{ 
                  color: "#1f2937", 
                  fontSize: "0.875rem",
                  marginTop: "2px",
...
export default DeleteIncompleteOrderModal;
