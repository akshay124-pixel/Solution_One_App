...
function PasswordExpiredScreen() {
  ...
  const { logout, fetchPasswordStatus, setPasswordStatus } = usePortalAuth();
  ...
  return (
    ...
    >
      <div className="form-box" style={{ width: "550px" }}>
        <form className="form" onSubmit={handleSubmit}>
          <h2 className="title">Password Expired</h2>
          <p className="subtitle" style={{ color: "#dc3545", fontWeight: 600 }}>
            Your password has expired. To continue using the system, please create a new password.
          </p>
