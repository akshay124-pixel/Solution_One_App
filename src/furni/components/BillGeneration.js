...
import { Button, Form, Badge, Spinner, InputGroup } from "react-bootstrap";
import {
  FaEye,
  FaSearch,
  FaFilter,
    ...
    if (billStatusFilter !== "All") {
      if (billStatusFilter === "BillPending") {
        filtered = filtered.filter(
          (order) => !order.billNumber || order.billNumber.trim() === "",
        );
      } else if (billStatusFilter === "PIPending") {
        filtered = filtered.filter(
          (order) => !order.piNumber || order.piNumber.trim() === "",
        );
      } else {
        filtered = filtered.filter(
          ...
          >
            ...
            <tbody>
              {filteredOrders.length > 0 ? (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <svg height="18px" viewBox="0 0 512 512" fill="#ffffff">
                ...
                <tr>
                  <td colSpan="12" style={{ height: "300px" }}></td>
                </tr>
              )}
            </tbody>
          </table>
